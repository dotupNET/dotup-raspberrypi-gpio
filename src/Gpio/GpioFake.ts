...
export class Gpio extends EventEmitter {
   ...
   * @param level     0 or 1
   */
  digitalWrite(level: number): Gpio { return this; }
   ...
   * @param level     0 or 1
   */
  trigger(pulseLen: number, level: number): Gpio { return this; }

  /**
   * Starts PWM on the GPIO. Returns this.
   * @param dutyCycle     an unsigned integer >= 0 (off) and <= range (fully on). range defaults to 255.
   */
  pwmWrite(dutyCycle: number): Gpio { return this; }

  /**
   * The same to #pwmWrite.
   * @param dutyCycle     an unsigned integer >= 0 (off) and <= range (fully on). range defaults to 255.
   */
  analogWrite(dutyCycle: number): Gpio { return this; }
   ...
   */
  hardwarePwmWrite(frequency: number, dutyCycle: number): Gpio { return this; }
   ...
   */
  pwmRange(range: number): Gpio { return this; }
   ...
   */
  pwmFrequency(frequency: number): Gpio { return this; }
   ...
   */
  servoWrite(pulseWidth: number): Gpio { return this; }
   ...
   */
  enableInterrupt(edge: number, timeout?: number): Gpio { return this; }

  /**
   * Disables interrupts for the GPIO. Returns this.
   */
  disableInterrupt(): Gpio { return this; }

  /**
   * Enables alerts for the GPIO. Returns this.
   */
  enableAlert(): Gpio { return this; }

  /**
   * Disables aterts for the GPIO. Returns this.
   */
  disableAlert(): Gpio { return this; }
   ...
   */
  glitchFilter(steady: number): Gpio { return this; }
...
export class GpioBank {
   ...
   */
  set(bits: number): GpioBank { return this; }
   ...
   */
  clear(bits: number): GpioBank { return this; }
 ...
 * PI_CLOCK_PWM
 */
export const CLOCK_PWM: number = 0;

/**
 * PI_CLOCK_PCM
 */
export const CLOCK_PCM: number = 0;
